                ...
                <form>
                    ...
                    <div class="form-group">
                      ...
                      <select name="weight" class="form-control" id="weight">
                        <option value='1' {{($criteria->weight=='1')?'selected':''}}>(1) Not Important</option>
                        <option value='2' {{($criteria->weight=='2')?'selected':''}}>(2) Slightly Important</option>
                        <option value='3' {{($criteria->weight=='3')?'selected':''}}>(3) Important</option>
                        <option value='4' {{($criteria->weight=='4')?'selected':''}}>(4) Very Important</option>
                        <option value='5' {{($criteria->weight=='5')?'selected':''}}>(5) Extremely Important</option>
                      </select>
                    </div>
