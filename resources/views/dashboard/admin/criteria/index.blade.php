...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="col-lg-4">
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm mb-4">
                <div class="card-header font-weight-bold text-light bg-primary">List Criteria</div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered" id="data" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <td>
                                <a href="{{route('criteria.show',['id'=>$criteria->id])}}" class="btn btn-sm btn-dark"><i class="fas fa-layer-group"></i></a>
                                    <a href="/dashboard/criteria/{{$criteria->id}}/edit" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
