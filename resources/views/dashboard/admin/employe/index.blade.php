...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Fitter</h1>
  </div>
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card shadow-sm mb-4">
                <div class="card-header font-weight-bold text-light bg-primary">List Fitter
                <a href="{{route('employe.create')}}" class="btn btn-sm btn-primary float-right"><i class="fas fa-plus-square"></i> New Fitter</a></a>
                </div>
                        ...
                        <table class="table table-bordered" id="data" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <td>
                                    ...
                                    <a href="/dashboard/employe/{{$employe->id}}/edit" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
